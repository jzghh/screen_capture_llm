...
console.log("[ask-llm:m2] content script loaded");
...
function ensureUi() {
  ...
  panelEl.innerHTML = [
    ...
    '  <span class="ask-llm-panel__title">Ask LLM (M2)</span>',
    ...
    '  <button type="button" class="ask-llm-panel__submit">Ask (fake)</button>',
    '  <p class="ask-llm-panel__label">Answer (placeholder)</p>',
  ...
  /** @type {HTMLButtonElement | null} */
  const submitBtn = panelEl.querySelector(".ask-llm-panel__submit");
...
function onMouseUp() {
  ...
  console.log("[ask-llm:m2] selection:", text);
